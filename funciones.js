...
function girarRuleta(){
    ...
    if(vidas==0){
        ...
        if(aux >= 1000){
            ...
            setTimeout(() => {
                console.log(responder(temaElegido, numero))
              }, 1400);
        }
    }
...
function responder(temaElegido, numero){
    ...
    document.getElementById(numero).style.width="200px";
    document.getElementById(numero).style.height="200px";
